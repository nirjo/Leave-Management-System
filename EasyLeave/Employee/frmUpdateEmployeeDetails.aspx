<%@ Page Language="C#" MasterPageFile="~/Employee/EmployeeMasterPage.master" AutoEventWireup="true" CodeFile="frmUpdateEmployeeDetails.aspx.cs" Inherits="Employee_frmEditEmployeeDetails" Title="Untitled Page" %>
...
<td colspan="2" style="height: 26px">
    ...
    <asp:Button ID="Button1" runat="server" Text="Update" OnClick="btnUpdate_Click" Width="65px" />&nbsp;
    <asp:Button ID="Button2" runat="server" Text="Back" OnClick="btnBack_Click" CausesValidation="False" Width="65px" />
    </td>
</tr>
</table></td></tr></table>
</asp:Content>
